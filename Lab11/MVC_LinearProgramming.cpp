...
int main()
{
   ...
   /* n = 2, m = 3;
    ...
    A[1][0]=1; A[1][1]=0;A[1][2]=1;A[1][3]=0;A[1][4]=0;A[1][5]=0;
    A[2][0]=0; A[2][1] = 1;A[2][2]=1;A[2][3]=0;A[2][4]=0;A[2][5]=0;
    A[3][0] = 0; A[3][1] = 1;A[3][2]=0;A[3][3]=1;A[3][4]=0;A[3][5]=0;
    A[4][0]=0;A[4][1]=0;A[4][2]=1;A[4][3]=0;A[4][4]=0;A[4][5]=1;
    A[5][0]=0;A[5][1]=0;A[5][2]=0;A[5][3]=1;A[5][4]=0;A[5][5]=1;
    ...
    */
    ...
    A[2][0]=0; A[2][1]=1; A[2][2]=1; A[2][3]=0; A[2][4]=0; A[2][5]=0;
    A[3][0]=0; A[3][1]=1; A[3][2]=0; A[3][3]=1; A[3][4]=0; A[3][5]=0;
    A[4][0]=0; A[4][1]=0; A[4][2]=1; A[4][3]=0; A[4][4]=1; A[4][5]=0;
    A[5][0]=0; A[5][1]=0; A[5][2]=0; A[5][3]=1; A[5][4]=1; A[5][5]=0;
    A[6][0]=0; A[6][1]=0; A[6][2]=0; A[6][3]=1; A[6][4]=0; A[6][5]=1;
...
//Output
// Pivoting variable 3 around constraint 0.
// --------------------
// State:
// Maximise: 1.000000x_0 + 1.000000x_1 + 1.000000x_2 + -1.000000x_4 + -1.000000
// Subject to:
// -1.000000x_0 + -1.000000x_1 + -1.000000x_2 + 1.000000x_4 + 1.000000 = x_3
// 0.000000x_0 + 0.000000x_1 + 0.000000x_2 + 1.000000x_4 + 0.000000 = x_5
// Pivoting variable 0 around constraint 0.
// --------------------
// State:
// Maximise: -1.000000x_3 + 0.000000x_1 + 0.000000x_2 + 0.000000x_4 + 0.000000
// Subject to:
// -1.000000x_3 + -1.000000x_1 + -1.000000x_2 + 1.000000x_4 + 1.000000 = x_0
// -0.000000x_3 + 0.000000x_1 + 0.000000x_2 + 1.000000x_4 + 0.000000 = x_5
// --------------------
// State:
// Maximise: -1.000000x_3 + 0.000000x_1 + 1.000000x_2 + -1.000000
// Subject to:
// 1.000000x_3 + -1.000000x_1 + -1.000000x_2 + 1.000000 = x_0
// 1.000000x_3 + 0.000000x_1 + 0.000000x_2 + 0.000000 = x_4
// Pivoting variable 2 around constraint 0.
// --------------------
// State:
// Maximise: 0.000000x_3 + -1.000000x_1 + -1.000000x_0 + 0.000000
// Subject to:
// 1.000000x_3 + -1.000000x_1 + -1.000000x_0 + 1.000000 = x_2
// 1.000000x_3 + 0.000000x_1 + -0.000000x_0 + 0.000000 = x_4
// Solution: (0.000000, 0.000000, 1.000000, )
// Optimal objective value: 0.000000
// X[0]=0
// X[1]=0
// X[2]=1
// Approximate solution size=1